  ...
  return (
    <footer className="bg-sidebar text-slate-300">
      <div className="container-x grid gap-12 py-14 lg:grid-cols-2">
        ...
        <div className="grid grid-cols-2 gap-8">
          <nav aria-label="Quick links">
            <h2 className="font-mono text-xs uppercase tracking-[0.25em] text-slate-400">Quick Links</h2>
          ...
          <nav aria-label="Company links">
            <h2 className="font-mono text-xs uppercase tracking-[0.25em] text-slate-400">Company</h2>
            <ul className="mt-4 space-y-2.5">
      ...
      <div className="border-t border-white/10">
        <div className="container-x flex flex-col gap-2 py-6 text-sm text-slate-400 sm:flex-row sm:items-center sm:justify-between">
